...
final kLiKeButtonKey = Key('like-button');
final kNextButtonKey = Key('next-button');
final kQuoteTextKey = Key('quote-text');
final kAuthorTextKey = Key('author-text');
final kQuotePageKey = Key('quote-page');
final kFavoritesPageKey = Key('favorites-page');
